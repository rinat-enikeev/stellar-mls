...
specified in Appendix~\ref{app:bench} and whose source lives at
\texttt{benchmarks/onym-groth16-bls12381/} in this paper's source
tree; rows C2--C6 cite published numbers attributed inline; row C7 is
...
\begin{itemize}
  \item \textbf{Native pairing precompiles dominate the cheap end.}
    ...
    BLS12-381 pairing host function~\cite{stellar-cap-0058} and the
