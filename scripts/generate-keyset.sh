...
echo "  # UpdateCircuit keys (v${VERSION} #59 fix):"
echo "  for tier in small medium large; do"
echo "    cp $OUT_DIR/\$tier/update_proving_key.bin clients/android/StellarChat/app/src/main/assets/keyset-v${VERSION}/update-\$tier.bin"
echo "    cp $OUT_DIR/\$tier/update_proving_key.bin clients/ios/StellarChat/StellarChat/Resources/keyset-v${VERSION}/update-\$tier.bin"
echo "  done"
echo ""
fi
